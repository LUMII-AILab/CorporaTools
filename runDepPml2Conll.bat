...
perl -e "use LvCorporaTools::FormatTransf::DepPml2Conll qw(transformFile); transformFile(@ARGV)" testdata\DepPml2Conll zeens-dep.xml zeens-unlabeled.conll 0 0

REM Labeled trees in "large" CoNLL format with custom POSTAG and CPOSTAG; single file.
perl -e "use LvCorporaTools::FormatTransf::DepPml2Conll qw(transformFile POSTAG CPOSTAG); $POSTAG = 'FULL'; $CPOSTAG = 'FIRST'; transformFile(@ARGV)" testdata\DepPml2Conll zeens-dep.xml zeens-omit-reductions.conll 1 1
