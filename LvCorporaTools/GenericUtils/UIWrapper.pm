...
#			 of result files (no aditional dot is added), data directory,
#			 arbitrary list of other parameters to pass to file processing
#			 function)
# Function for file processing will be used according to signature (data
# directory prefix, input file (without dir name), output file, other
# parameters)
sub processDir
{
